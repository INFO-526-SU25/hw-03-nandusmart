...
covid_survey_summary <- covid_survey_longer |>
  ...
  summarise(
    mean_value = mean(response_value, na.rm = TRUE),
    quantile_10 = quantile(response_value, probs = 0.1, na.rm = TRUE),
    quantile_90 = quantile(response_value, probs = 0.9, na.rm = TRUE),
    .groups = "drop"
  )
...
covid_survey_summary_all <- covid_survey_longer |>
  ...
  summarise(
    mean_value = mean(response_value, na.rm = TRUE),
    quantile_10 = quantile(response_value, 0.1, na.rm = TRUE),
    quantile_90 = quantile(response_value, 0.9, na.rm = TRUE),
    .groups = "drop"
  ) |>
  mutate(
    explanatory = "All",
